"""
Django settings for prepair_41445 project.
...
ROOT_URLCONF = 'prepair_41445.urls'
...
WSGI_APPLICATION = 'prepair_41445.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "prepair_41445 API",
    "DESCRIPTION": "API documentation for prepair_41445 App",
    "VERSION": "v1",
}
